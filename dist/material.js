 ...
 * limitations under the License.
 */
/* This file has been modified by Felipe Amado (at Kekanto/Delivery Direto)
 * on Feb 9th so the ripple effect only happens on click */
/**
    ...
    if (this.element_) {
        ...
        if (!this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT_IGNORE_EVENTS)) {
            ...
            this.element_.addEventListener('click', function (e) {
                self.boundDownHandler(e);
                self.boundUpHandler(e);
            });
            /**
